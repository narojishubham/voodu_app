  ...
  return (
    <>
      <div
        className={
          showTitle
            ? 'video-cards video-cards-hide'
            : 'video-cards video-cards-show'
        }
      >
        <video
          onClick={window.innerWidth <= 650 ? onVideoClick : onVideoClick}
          onMouseOver={window.innerWidth >= 650 ? startVideo : null}
